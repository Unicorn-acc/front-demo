...
# 二、DOM 基础（Document Object Model）
...
![](https://cdn.jsdelivr.net/gh/Unicorn-acc/blogimgs/imgs05/js1.3f1t9u88n880.png)
...
![bom1](https://cdn.jsdelivr.net/gh/Unicorn-acc/blogimgs/imgs05/bom1.3ss67gfjn6c.png)
...
JavaScript 语言的一大特点就是 **单线程**，也就是说，**同一个时间只能做一件事**。这是因为 Javascript 这门脚本语言诞生的使命所致——JavaScript 是为处理页面中用户的交互，以及操作DOM 而诞生的。比如我们对某个DOM 元素进行添加和删除操作，不能同时进行。应该先进行添加，之后再删除。  
...
![bom2](https://cdn.jsdelivr.net/gh/Unicorn-acc/blogimgs/imgs05/bom2.40uo3yu1dv20.png)
...
![](https://cdn.jsdelivr.net/gh/Unicorn-acc/blogimgs/imgs05/bom3.720uz5f9vh00.png)
...
`offset` 系列常用属性：
![](https://cdn.jsdelivr.net/gh/Unicorn-acc/blogimgs/imgs05/offset1.33r96uboi540.jpg)
...
![](https://cdn.jsdelivr.net/gh/Unicorn-acc/blogimgs/imgs05/client1.6bor0qa82lk0.png)
...
如下图所示
![](https://cdn.jsdelivr.net/gh/Unicorn-acc/blogimgs/imgs05/scroll1.4xrvppmwt800.png)
